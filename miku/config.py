...
class MikuConfig:
    def __init__(self):
        ...
        self.WORKERS = self._get_env_var("WORKERS", required=False, cast=int, default=24)
        self.LOG_CHANNEL_ID = self._get_env_var("LOG_CHANNEL_ID", cast=int)
        self.DATABASE_NAME = self._get_env_var("DATABASE_NAME", required=False, default="MikuDB.sqlite3")
