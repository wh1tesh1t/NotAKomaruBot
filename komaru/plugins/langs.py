...
from komaru.database.localization import set_db_lang
from komaru.utils.decorators import require_admin
from komaru.utils.localization import Strings, langdict, use_chat_lang
...
@Client.on_callback_query(filters.regex(f"^{MENU_LANG}$"))
